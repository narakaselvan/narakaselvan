...
from acsl.assignments.prepare_testData import show_preload_generator
...
def show_admin():
    ...
    with sub_tabs[0]:
        assign_sub_tabs = st.tabs(["Prepare Assignments", "Upload to SuSo", "Test Data" ,"Download Assignments", "Upload to LocalDB", "Revert Assignments"])
